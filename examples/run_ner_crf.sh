#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python examples/NERCRF.py --cuda --mode LSTM --num_epochs 300 --batch_size 16 --hidden_size 256 --num_layers 1 \
 ...
 --train "data/OPP-115/opp115.train.bio.conll03" --dev "data/OPP-115/opp115.test.bio.conll03" --test "data/OPP-115/opp115.test.bio.conll03"
# CUDA_VISIBLE_DEVICES=0 python examples/NERCRF.py --cuda --mode LSTM --num_epochs 200 --batch_size 16 --hidden_size 256 --num_layers 1 \
